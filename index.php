...
<head>
     ...
     <title>Afif Galih Shop</title>
</head>

<body background="img/bg/tokopak.jpeg">
<style>
        body{
     ...
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Beranda Customer A5 Shop</a>
               ...
               <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                         <li class="nav-item">
                              <a class="nav-link" aria-current="page" href="#">Afif Galih Shop</a>
                         </li>
                         <li class="nav-item">
     ...
     <div class="container">
          <div class="row my-2">
               <div class="col-md">
                    <h3 class="text-center fw-bold text-uppercase text-light crudtopak_sti202102196"></h3>
                    <hr>
               </div>
          </div>
          <div class="row my-2">
                              ...
                              <tr class="table-secondary text-dark">
                                   ...
                                   <td>
                                        ...
                                        <a href="hapus.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-sm"
                                             ...
                                             onclick="return confirm('Apakah anda yakin ingin menghapus data <?= $row['kode_barang']; ?> ?');"><i
     ...
     <div class="container-fluid">
          <div class="row bg-dark text-white text-center">
               <div class="col my-2" id="about">
                    <p>
                         copyright - Afif Galih (STI202102196)
                    </p>
               </div>
          </div>
     </div>
     ...
     gsap.to('.crudtopak_sti202102196', {
          duration: 1,
          delay: 0.6,
          text: 'Data Check Shop A5'
     })
     gsap.from('.navbar', {
          duration: 1,
          y: '-100%',
